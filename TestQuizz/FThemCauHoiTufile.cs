...
namespace TestQuizz
{
    public partial class FThemCauHoiTufile : Form
    {
        public string lop {  get; set; }
        public string mon { get; set; }
        private string currentFilePath;
        public FThemCauHoiTufile()
        {
            InitializeComponent();
        }
        ...
        private void SaveQuestionToDatabase()
        {
            try
            {
                ...
                foreach (CauHoi cauHoi in danhSachCauHoi)
                {
                    ...
                    dbUtils.InsertCauHoiVaoThuVienCauHoi(cauHoi,lop);
                }
        ...
        private string RandomQuestionId()
        {
            ...
            string IdcauHoi =new string(randomArray);
            return IdcauHoi;
        }

        private void FThemCauHoiTufile_FormClosed(object sender, FormClosedEventArgs e)
        {
            if (Owner != null)
            {
                (Owner as FShowDanhSachCauHoi).LoadBangAllCauHoi();
            }
        }
    }
}
